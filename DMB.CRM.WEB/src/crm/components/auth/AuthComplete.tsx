...
export default function AuthComplete() {
  ...
  const onVerify = async (e: FormEvent) => {
    ...
    setError("");
    try {
      const res = await http.post<{ token: string; locations?: any[]; currentLocationId?: string }>(
      ...
      await acceptSession(res.data.token, res.data.locations, res.data.currentLocationId);
