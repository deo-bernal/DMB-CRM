import { resolveOAuthApiBaseUrl } from "../../../config";
...
function startHref(provider: string) {
  ...
  return `${apiBase}/auth/external/${provider}/start?client=web`;
}
  ...
  return (
    <div className="sso-stack">
      {PROVIDERS.map((provider) => {
        return (
          <a key={provider.id} className="sso-button" href={startHref(provider.id)}>
